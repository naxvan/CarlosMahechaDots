  ...
  -- Description: A Neovim plugin for creating a customizable dashboard.
  {
    ...
    opts = {
      dashboard = {
        ...
        preset = {
          header = [[
      🌟 La clave no está solo en escribir código, sino en escribirlo con propósito. 🛠️ 
      Como un arquitecto de soluciones elegantes, tu trabajo es más que solo líneas de código; es la base de algo grande.
      💡 Sé la guía para los demas y comparte tu sabiduría con el equipo. 
      🚀 ¡Sigue construyendo, la excelencia está en los detalles! 💻👨
]],
        -- stylua: ignore
